...
|       NC News Frontend    |
|       NC News Backend     |
|     Tetriplan Frontend    |Tetriplan is a productivity app focused on time-blocking, making use of AI to streamline adding and categorising tasks.| Node.js, Angular CLI, Mongodb, AI |
